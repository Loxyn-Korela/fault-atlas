...
FLAG = """<svg viewBox="0 0 60 40" width="21" height="14" aria-hidden="true" class="fg"><rect width="20" height="40" fill="#002395"/><rect x="20" width="20" height="40" fill="#fff"/><rect x="40" width="20" height="40" fill="#ED2939"/></svg>""" if LANG == "en" else """<svg viewBox="0 0 60 40" width="21" height="14" aria-hidden="true" class="fg"><rect width="60" height="40" fill="#012169"/><path d="M0 0 60 40M60 0 0 40" stroke="#fff" stroke-width="8"/><path d="M0 0 60 40M60 0 0 40" stroke="#C8102E" stroke-width="4"/><path d="M30 0v40M0 20h60" stroke="#fff" stroke-width="13"/><path d="M30 0v40M0 20h60" stroke="#C8102E" stroke-width="8"/></svg>"""
...
.lang{display:inline-flex;align-items:center;padding:2px}.lang svg.fg{display:block;border-radius:2px;box-shadow:0 0 0 1px rgba(0,0,0,.18);opacity:.9;transition:opacity .15s}.lang:hover svg.fg,.lang:focus-visible svg.fg{opacity:1}
